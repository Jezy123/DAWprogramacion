...
public class Estadisticas2 {
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Numero de palabras = " + numeroDePalabras + "\n" +
                ...
                ((numeroDeVocales * 100) / (numeroDeConsonantes + numeroDeEspacios + numeroDeVocales + numeroDeTab))
                + " % de vocales \n" +
                ((numeroDeConsonantes * 100) / (numeroDeConsonantes + numeroDeEspacios + numeroDeVocales + numeroDeTab))
                + " % de consonantes \n" +
                ((numeroDeEspacios * 100) / (numeroDeConsonantes + numeroDeEspacios + numeroDeVocales + numeroDeTab))
                + " % de espacios \n" +
                ((numeroDeTab * 100) / (numeroDeConsonantes + numeroDeEspacios + numeroDeVocales + numeroDeTab))
                + " % de tabuladores \n");
